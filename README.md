 **_NOTE:_**  This project is best run on Eclipse. There is also no main method since the main goal of this project is to practice unit testing and write clean code. Original Project: https://github.com/USM-COS470-S21/rpn-calculator-aidan-ho-solo
